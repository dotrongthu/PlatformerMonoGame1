...
namespace Familyheart_DX11.SceneManager
{
    ...
    public class TileMap
    {
        ...
        private List<SegmentDefinition> objectSprite;

        public string name;

        public TileMap()
        {
            objectSprite = new List<SegmentDefinition>();
        }
        ...
        public List<SegmentDefinition> ObjectSprites
        {
        ...
        public bool DrawMapSegments(SpriteBatch batch, int viewportWidth, int viewportHeight)
        {
            ...
            for (int i = 0; i < objectSprite.Count(); i++)
            {
                ...
                sourceRect = objectSprite[i].DrawRectangle;

                batch.Draw(tileMaps[objectSprite[i].SourceMapIndex], destination, null, sourceRect, new Vector2(0,0), 0, null, null, 0);
